...
var ASM_CONSTS = {
  3238432: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3238493: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3238557: function() {return Module.webglContextAttributes.powerPreference;},  
 3238615: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3238670: function($0) {performance.now = function() { return $0; };},  
 3238718: function($0) {performance.now = function() { return $0; };},  
 3238766: function() {performance.now = Module['emscripten_get_now_backup'];}
};
...
/** @type {function(...*):?} */
var dynCall_viiiffffffffii = Module["dynCall_viiiffffffffii"] = createExportWrapper("dynCall_viiiffffffffii");
